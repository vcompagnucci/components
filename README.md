...
| ↳ el video termina cuando termina la animación | el máster sigue entero (5.45 s, con el reinicio); lo que se corta es la ENTREGA, a 4.10 s. Los cuatro de X se renderizan desde un clip cortado, con la salida de la cámara arrancando a los 3.00; los dos pares de la library se cortan del render ya hecho con `-c copy`, que en ellos es equivalente porque su cámara no sale | Vito, 2026-09-08: "hacé que el video se corte antes, o sea cuando termina la animación y listo, bien natural, que no se espere a volver", y después "que haya más tiempo luego que termine". RUNTIME (diferencia entre cuadros consecutivos en la banda del pill y su entorno): las dos apariencias se quedan quietas a los 3.00 s —"✓ Order Placed" enfocado y la ráfaga apagada— y siguen quietas hasta los 4.33, que es cuando el reinicio se mueve. 4.10 deja 1.10 s con el resultado en pantalla y 0.23 de margen. La medición fija el techo; el aire lo eligió él. El corte con `-c copy` no toca el alfa: verificado en Chrome dibujando el video sobre un canvas rojo, la esquina sale roja pura |
