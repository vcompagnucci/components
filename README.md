...
| Riel | **EN ESTUDIO** — scrubber en `src/proto/rail.tsx`, entre **584** (benji, su 36.375rem redondeado a la escala de 4) y **672** (josh, 42rem exacto). Con el margen ya horneado, la columna va de 552 a 640 | los dos referentes convergen en una columna angosta pero por construcciones opuestas; el nuestro venía de 832, del DESIGN.md de Carousels, y nunca se había mirado contra esta página. Lo que decide de verdad es una pieza real adentro |
