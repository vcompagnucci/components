...
/* ⚠ EN ESTUDIO — el rótulo del índice. Se va con src/proto/. */
import { NavPicker, useNav } from './proto/nav'
...
export function App() {
  ...
  return (
    <div className={`${css.page} ${nav.cls}`}>
      <Index />
      <Masthead />
      ...
      {/* ⚠ EN ESTUDIO */}
      <NavPicker i={nav.i} setI={nav.setI} />
    </div>
  )
}
