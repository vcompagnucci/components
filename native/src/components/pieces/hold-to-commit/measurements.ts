...
export const TEXTO = {
  ...
  /* RUNTIME · "Committed" mide 86.7 pt de tinta en el clip; SF a 17 da
     ...
     `media/generate.swift`). Es SEMIBOLD: se veía más pesado en las tiras
...
export const SIMBOLO = {
  ...
  /* EL `size` DE SymbolView NO ES EL TAMAÑO DEL GLIFO. SOURCE: en
     ...
     impresa por `media/generate.swift`— y el `scaleAspectFit` por defecto
...
export const FRENTE = {
  /* RUNTIME · la caída del frente: σ = 19 pt (51 pt del 90 % al 10 % en
     ...
     arriba de `frente.png` en `media/generate.swift`. */
  antes: 83,
  despues: 57,
...
export const LABEL = {
  /* Los textos de Opal eran 'Hold to Commit' / 'Keep Holding...' /
     ...
     borrosas se regeneran con `media/generate.swift`. */
  reposo: 'Hold to Buy',
  ...
  /* RUNTIME · de la tinta de la tilde a la C: 33 px = 12 pt. La caja de
     ...
     de bearing: 12 − 1.7 − 1 ≈ 9. `media/generate.swift` usa el MISMO
