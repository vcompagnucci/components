...
import { COLOR, COMMIT, LABEL, SIMBOLO, TEXTO } from './measurements'
...
/* ═══════════════════════════════════════════════════════════════
   ...
   ver `media/generate.swift`), así que cada label tiene TRES copias: el
...
const BORROSO = {
  ...
  listo: { a: require('./media/committed-blurred-a.png'), b: require('./media/committed-blurred-b.png') },
  ...
  tilde: require('./media/checkmark-blurred.png'),
}
